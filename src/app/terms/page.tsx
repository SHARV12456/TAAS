...
export const metadata = { title: 'Terms of Service | Design Hour' };
    ...
    <main><Navbar />
      <div style={{ paddingTop: '6rem', paddingBottom: '4rem', background: 'var(--color-white)', minHeight: '100vh' }}>
        <div className="container" style={{ maxWidth: 720 }}>
          ...
          {[
            ['1. Acceptance', 'By booking a consultation with Design Hour, you agree to these Terms of Service. If you do not agree, please do not proceed with booking.'],
            ['2. The Service', 'Design Hour provides professional design consultation services by the hour. The service is advisory in nature. We do not manage interior design projects, procurement, contracting or construction.'],
            ...
            ['5. Limitation of Liability', 'Design Hour provides design advice and recommendations. We are not liable for the outcomes of decisions made based on our advice, or for work carried out by third-party contractors, vendors or manufacturers.'],
