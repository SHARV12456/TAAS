...
export const metadata = {
  title: 'Design Consultation in Seven Bungalows | Design Hour',
  ...
  return (
    <main>
      ...
      <div style={{ padding: '6rem 2rem', maxWidth: 1200, margin: '0 auto', minHeight: '60vh' }}>
        <h1 style={{ fontSize: '3rem', fontWeight: 800, marginBottom: '2rem' }}>Design Consultation in Seven Bungalows</h1>
